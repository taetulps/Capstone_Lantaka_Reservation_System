...
<header class="header">
        <div class="header-container">
            ...
            <nav class="nav">
                <a href="{{ route('client_room_venue') }}" class="nav-link nav-item {{ request()->routeIs('client_room_venue') ? 'active' : '' }}">Accommodation</a>

                <a href="{{ route('login') }}" class="nav-link">Login</a>
                <a href="{{ route('client_my_bookings') }}" class="nav-link nav-item {{ request()->routeIs('client_my_bookings') ? 'active' : '' }}">My Booking</a>
                <a href="{{ route('client_my_reservations') }}" class="nav-link nav-item {{ request()->routeIs('client_my_reservations') ? 'active' : '' }}">My Reservations</a>
                <button class="icon-btn">🔔</button>
                <div class="user-profile" id="open-modal">
                    <div class="user-avatar">👤</div>
                    <div class="user-info">
                        <p class="user-name">Client test</p>
                    </div>
                </div>
